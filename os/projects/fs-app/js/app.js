...
// Bootstrap.
Shell.getInstance().execute(shlex('create log.txt')).execute(shlex('create mail.txt')).execute(shlex('mkdir Documents')).execute(shlex('cd Documents')).execute(shlex('create diary.docx')).execute(shlex('cd ..'));
