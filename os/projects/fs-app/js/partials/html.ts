...
export var filesDirectoryDir = ["<div class=\"file col-sm-2\" data-name=\"<%= name %>\" title=\"<%= infos %>\">","    <a data-path=\"<%= path %>\">","        <header class=\"file-icon\">","            <i class=\"fa fa-folder-o\"></i>","        </header>","        <section class=\"file-meta\">","            <h3><%= name %></h3>","        </section>","    </a>","</div>",""].join("\n");
export var filesDirectoryFile = ["<div class=\"file col-sm-2\" data-name=\"<%= name %>\" title=\"<%= infos %>\">","    <header class=\"file-icon\">","        <i class=\"fa fa-file-word-o\"></i>","    </header>","    <section class=\"file-meta\">","        <h3><%= name %></h3>","    </section>","</div>",""].join("\n");
...
export var userInfosMe = ["<p>当前用户：<span class=\"badge\"><%= currentUserName %></span></p>","<p>用户总数：<span class=\"badge\"><%= count %></span></p>",""].join("\n"); 
}
